...
function cosmosfarm_members_search_product(product_id){
	if(product_id){
		...
		jQuery.post(cosmosfarm_members_admin_settings.post_url,{action:'cosmosfarm_members_search_product', product_id:product_id, security:cosmosfarm_members_admin_settings.ajax_nonce}, function(res){
