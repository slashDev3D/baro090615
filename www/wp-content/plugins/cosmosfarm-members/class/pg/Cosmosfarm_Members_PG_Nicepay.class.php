...
class Cosmosfarm_Members_PG_Nicepay extends Cosmosfarm_Members_Abstract_PG {
	...
	public function getPayment(){
		...
		if(isset($_SESSION['payment'])){
			if($_SESSION['payment']->ResultCode == '3001'){
				$payment['status'] = 'paid';
				...
				$payment['receipt_url'] = "https://npg.nicepay.co.kr/issue/IssueLoaderMail.do?TID={$payment['builtin_pg_tid']}&type=0";
	...
	public function get_init_values(){
		...
		$values['custom_data']       = isset($_POST['custom_data']) ? base64_encode($_POST['custom_data']) : ''; // 한글 입력 불가
	...
	public function callback(){
		...
		if($auth_result_code == '0000'){
			...
			if($result->ResultCode == '3001'){
				$custom_data = isset($_POST['custom_data']) ? base64_decode($_POST['custom_data']) : '';
